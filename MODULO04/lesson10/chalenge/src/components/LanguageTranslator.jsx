...
const LanguageTranslator = () => {
  ...
  const translateText = async () => {
    try {
        const response = await axios.get(`https://translate.googleapis.com/translate_a/single?client=gtx&sl=${selectedLanguage}&tl=${targetLanguage}&dt=t&q=${encodeURI(text)}`, {
            params: {
                q: text,
